...
client.mutate({
    mutation2: gql`
    mutation signup{
        signup(data:{username:"davidr1231rrrr",password:"1234123125678",email:"rami1322ro@gmail.com"})}
    `
  }).then(resulta2 => console.log(resulta2));
                        ...
                        <form onSubmit={formik.handleSubmit} className="p-fluid">
                            <div className="field py-2">
                                <span className="p-float-label">
                                    ...
                                    <label htmlFor="name" className={classNames({ 'p-error': isFormFieldValid('name') })}>Username*</label>
                                </span>
